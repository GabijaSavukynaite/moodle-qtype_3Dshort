 ...
 * qtype/model3dshort/classes/model3dshort.ts in the core app
 * e.g.
...
var result = {
  componentInit: function () {
    ...
    this.question.text = this.CoreDomUtilsProvider.getContentsOfElement(
      div,
      ".qtext"
    );
    ...
    if (typeof this.question.text == "undefined") {
      this.logger.warn(
        "Aborting because of an error parsing question.",
        this.question.name
      );
